...
public class NewsController {
	...
	@GetMapping("/editar")
	public String actualizarNoticia(@RequestParam("id") int id, @ModelAttribute("news") News noticiaActualizada,
	...
	public String eliminarCategoria(@PathVariable("id") Integer id) {
		...
		News noticia = newsRepository.findById(id)
				.orElseThrow(() -> new IllegalArgumentException("Noticia no encontrada com id: " + id));
